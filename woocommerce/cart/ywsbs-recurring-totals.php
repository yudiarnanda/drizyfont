...
<div class="review-order-content">
	<div class="product-total-label ywsbs-recurring-total-title"><?php esc_html_e( 'Recurring totals', 'yith-woocommerce-subscription' ); ?></div>
	<div class="product-total recurring-amounts-list">
		<?php
