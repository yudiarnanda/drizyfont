...
<div class="woocommerce-MyAccount-title"><?php esc_html_e( 'Enter your payment details', 'woocommerce' ); ?></div>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<div class="section-not-found add-payment">
		<div class="button-effect">
			<a class="button" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><span><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></span></a>
		</div>
	</div>
<?php endif; ?>
