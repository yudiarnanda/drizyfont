...
<?php else : ?>
	...
	<form method="post">
		...
		<div class="woocommerce-MyAccount-title"><?php echo apply_filters( 'woocommerce_my_account_edit_address_title', $page_title, $load_address ); ?></div><?php // @codingStandardsIgnoreLine ?>
