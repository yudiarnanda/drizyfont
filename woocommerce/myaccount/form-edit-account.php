...
<div class="woocommerce-MyAccount-title"><?php esc_html_e( 'Account Details', 'woocommerce' ); ?></div>
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="woocommerce-change-password">
		<div class="woocommerce-MyAccount-title"><span><?php esc_html_e( 'Password change', 'woocommerce' ); ?></span></div>
